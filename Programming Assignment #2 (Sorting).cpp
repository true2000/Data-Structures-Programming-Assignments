...
Input: 
The first line contains T denoting the number of test cases. Each test case contains three lines. 
...
Output: 
Print YES if it is possible for each boy to dance with a girl else print NO.
